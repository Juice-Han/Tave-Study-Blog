  ...
  return (
    <div className="max-w-md mx-auto mt-20 border p-6 rounded-lg shadow">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <input className="w-full border p-2 rounded" placeholder="아이디" value={username} onChange={(e) => setUsername(e.target.value)} />
        ...
        <button className="w-full bg-blue-500 text-white p-2 rounded">로그인</button>
      </form>
    </div>
  );
}
